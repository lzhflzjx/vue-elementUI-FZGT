            ...
            <el-col :span="24" class="bg-white">
                <el-form ref="form" :model="form" :inline="true" label-width="110px" style="padding-top: 10px">
                    <el-form-item label="映射分类：">
                        <el-select v-model="form.mappingType" size="medium" filterable clearable placeholder="请选择" style="width: 160px">
                            <el-option
                    ...
                    <el-form-item label="业务分类：">
                        <el-select v-model="form.type" size="medium" filterable clearable placeholder="请选择" style="width: 160px">
                            <el-option
                                v-for="item in businessClass"
                                :key="item.id"
                                :label="item.label"
                    ...
                    <el-form-item label="业务分类名称：">
                        <el-input v-model="form.sortName" clearable size="medium" style="width: 160px"></el-input>
                    </el-form-item>
                    <el-form-item label="业务分类号：">
                        <el-input v-model="form.sortNumber" clearable size="medium" style="width: 160px"></el-input>
                    </el-form-item>
                ...
                <el-main class="bg-white m-top">
                    <el-row style="margin-bottom: 10px">
                        <el-col :span="22">
                            <el-button type="primary"
                                       size="small"
                                       @click="$router.push({path: '/taxonomy/config'})">配置</el-button>
                            <el-upload
                        ...
                        >
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    <el-button
                                        @click.native.prevent="deleteRelevance(scope.row)"
                                        type="text"
                                        size="small">
                                        删除关联
                                    </el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            listData(data = {}){
                data.pageNo = data.pageNo ? data.pageNo : this.classPageNo;
                ...
                data.flag = 1;
                let that = this;
                that.classTotalCount = 0;
                that.tableData = [];
                this.$post('/api/sortRelationManage/findSortRelation', data).then(function (res) {
                    if (res.success && res.status === 0){
                        if (res.data.totalCount > 0){
                            that.classTotalCount = res.data.totalCount;
