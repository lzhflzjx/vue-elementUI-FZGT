  ...
  <div id="vendibilityManage">
    <div>
      <el-row>
        <el-col :span="4">
          <label>人工审读结果:</label>
          <el-select v-model="params[0].value[0]" clearable size="small" class="selectItem" style="width:130px">
            <el-option
    ...
    >
      ...
      <el-table-column prop="ctClassification" :show-overflow-tooltip="true" label="中图法">
        <template slot-scope="scope">
          <div>{{methods.classification(ctClassification,scope.row.ctClassification)}}</div>
        </template>
      </el-table-column>
      <el-table-column prop="bisacClassification" :show-overflow-tooltip="true" label="BISAC分类">
        <template slot-scope="scope">
